            ...
            <div className="row">
              <div className="col-lg-12">
                <form className="form_main" action onSubmit={submitFormData}>
                  ...
                  {errorMsg ? (
                    <div className="alert alert-denger p-1 display-inline-block">
                      {errorMsg}
                    </div>
                  ) : (
                    ""
                  ...
                  <button id="button">
                    Submit
                    {loading ? (
                      <i className="fa fa-spinner fa-spin text-white ps-2"></i>
                    ) : (
                      Login
                    )}
                  </button>
                  ...
                  <div className="signupContainer mt-2">
                    ...
                    <a
                      href={"/Register"}
                      className="text-white text-decoration-none btnSignUp"
                    >
                      Sign up
                    </a>
                  </div>
