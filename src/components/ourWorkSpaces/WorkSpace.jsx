    ...
    return (<>
        ...
        <div className={`${styles.Rooms}`}>
            <div className="container">
                ...
                <div className="row row-cols-1  row-cols-md-2 g-4">
                    {rooms.map((card, index) => (// <div className="col-le-1 cardHolder">
                    ...
                    <div className="col-lg-3">
                        <div className={`card ${styles.cards}`}>
                            <img
                                ...
                                src={pic4}
                                className={`card-img-top ${styles.cardImg}`}
                                alt="Shared Area Picture"
                            />
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-lg-8">
                                        <h6 id={"shared"} className="card-title">Shared Area</h6>
                    ...
                    <div className="col-lg-3">
                        <div className={`card ${styles.cards}`}>
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-lg-8">
                                        <h6 id={'silent'} className="card-title">Silent Room</h6>
                                        <p className="card-text">{sArea.numberOfSilentSeats} Seats</p>
                                        <p className={"card-text"}>{sArea.silentSeatPrice} EGP/ Hour</p>
                                    </div>
                                </div>
                            </div>
                            <a
        ...
        <div className="container">
            <div className={`${styles.details} my-2`}>
                ...
                <p onClick={visitGoogleMaps} className="mt-2">Address: {address}</p>
                <div className={"aboutSpace"}>
                    <div>
                        {dailyRoutine.map((routine, index) => (
                            <div key={index} style={{display: 'flex', margin: 24}} className="dailyRoutine">
